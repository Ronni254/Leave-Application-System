...
<head>
    ...
    <title>Admin Panel -Leave Application</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="shortcut icon" type="image/png" href="../assets/images/icon/admin.png">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6 clearfix">
                        <div class="user-profile pull-right">
                            <img class="img" src="../assets/images/icon/admin4.png" alt="png">
                    ...
                    <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                if($stats==1){
                                ?>
                                    <span style="color: green">Waiting for Management approval</span>
                                    <?php } if($stats==2)  { ?>
                                ...
                                <td ><b>Management Action: </b></td>
                                <td colspan="12">
                            <button type="button" class="btn btn-success" data-toggle="modal" data-target="#exampleModal">MANAGEMENT SET ACTION</button>
                            ...
                            <tr>
                            <td colspan="12">
                            <button type="button" class="btn btn-success" data-toggle="modal" data-target="#exampleModal">HoD SET ACTION</button>
