<?php
    ...
    header('location:../index.php');
        ...
        $sql="INSERT INTO tblleaves(LeaveType,FromDate,ToDate,Description,Status,IsRead,empid) VALUES(:leavetype,:fromdate,:todate,:description,:status,:isread,:empid)";
...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="../assets/images/icon/Sn54N45IwLK2wwjWoVlFGe6vTkQJZnuUoQGnWyv7.png">
                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="#">
                                <a href="leave-section.php" aria-expanded="true"><i class="ti-agenda"></i><span>View My Leave Types
                                    </span></a>
                            </li>
                            
                             <li class="#">
                                <a href="department.php" aria-expanded="true"><i class="ti-agenda"></i><span>View Departments
                                    </span></a>
                            </li>
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                 <li><a href="leave-history.php">My History</a></li>
                                ...
                                <form name="addemp" method="POST">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="date" value="yyyy/mm/dd" data-inputmask="'alias': 'date'" required id="example-date-input" name="fromdate" min="<?php echo date('Y-m-d'); ?>">
                                        </div>

                                        <div class="form-group">
                                            <label for="example-date-input" class="col-form-label">End Date</label>
                                            <input class="form-control" type="date" value="yyyy/mm/dd" data-inputmask="'alias': 'date'" required id="example-date-input" name="todate" min="<?php echo date('Y-m-d'); ?>">
                                        </div>
